...
<head>
	...
	<link rel="stylesheet" media="all" href="estilos.css?v=<?=time();?>" type="text/css" />
...
<!--ENCABEZADO DE LA PAGINA, campo buscar-->
	<header id="portada">		
		<div id="titulo"> CONSULTA DE PRECIOS CHILES Y SEMILLAS SAN JOSE 
        </div>
		
        <div id="encabezado">									
			<center>			
				<div id="cont_buscar">                    
                    <input type="search" id="campoBuscar" autofocus="true" placeholder="Buscar producto"/>
