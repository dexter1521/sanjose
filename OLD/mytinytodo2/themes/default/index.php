  ...
  <div class="mtt-tb-c">
   <form id="newtask_form" method="post">
    <label id="task_placeholder" class="placeholding" for="task">
     <input style="text-transform: uppercase;" type="text" name="task" value="" maxlength="250" id="task" autocomplete="off" />
...
<div class="form-row"><div class="h"><?php _e('task');?></div> <input style="text-transform: uppercase;" type="text" name="task" value="" class="in500" maxlength="250" /></div>
